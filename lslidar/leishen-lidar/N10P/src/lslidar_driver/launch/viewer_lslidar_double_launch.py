...
def generate_launch_description():
    ...
    driver_dir_1 = os.path.join(get_package_share_directory(
        'lslidar_driver'), 'params', 'lsx10_1.yaml')
    driver_dir_2 = os.path.join(get_package_share_directory(
        'lslidar_driver'), 'params', 'lsx10_2.yaml')
